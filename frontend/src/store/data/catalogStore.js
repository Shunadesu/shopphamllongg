...
// Cache chỉ tồn tại trong memory (không persist vào localStorage).
// Đảm bảo reload trang = fetch lại API, không bị stale do cache cũ.
// TTL ngắn để trong cùng session: chuyển route qua lại không bị refetch thừa.
